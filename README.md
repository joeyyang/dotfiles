    ...
    sh -c "`curl -fsSL https://raw.github.com/joeyyang/dotfiles/master/install.sh`"
...
```bash
sh -c "`curl -fsSL https://raw.github.com/joeyyang/dotfiles/master/install.sh`" -s ask
```
...
[![Bitdeli Badge](https://d2weczhvl823v0.cloudfront.net/joeyyang/dotfiles/trend.png)](https://bitdeli.com/free "Bitdeli Badge")
